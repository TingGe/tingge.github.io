  ...
  function render(b) {
    ...
    for(var i = 0, len = data.length; i < len; i++) {
      ...
      if (datum, "O1" !== datum.country && "O1" !== datum.country2) {
        ...
        }, d = +datum.dport, e = "hsl(" + +d % 360 + ", 100%, 70%)", f = A.findOne({port: d}) || A.insert({
            type: "service",
            port: d,
            color: e,
            service: "unknown",
        ...
        var g = c.source.document, h = c.target.document, i = moment().format("YYYY-MM-DD HH:mm:ss"), j = {
          timestamp: i,
          org: datum.org,
          ip: datum.md5,
          ...
          sourceCountry: datum.country,
          targetCountry: datum.country2,
          sourceObj: g,
          targetObj: h,
          serviceObj: f,
          service: f,
