...
// 单元数据格式化
  ...
  function (window, $) {
      ...
      if (datum, "O1" !== datum.country && "O1" !== datum.country2) {
        var c = {
          ...
          f =  Services.findOne({service: svc}) || Services.insert({
              ...
              service: svc || "未知",
              count: count,
              display: '<span style="color: ' + e + '">&bigcirc;</span> ' + (svc || '未知')
            });
        ++f.count,
          Services.update(f),
    ...
    var l, m, n, o, p, q, r, s, t, u, v = {},
      ...
      x = new loki("attacks"),
      y = x.addCollection("timeline", {indices: ["source", "target", "service"]}),
      z = x.addCollection("anchors", {indices: ["key", "country"]}),
      Services = x.addCollection("services", {indices: ["port"]}),
      B = x.addCollection("countries", {indices: ["country", "type"]}),
