...
感测、制图和规划是自动驾驶的三大支柱。需技术、立法、产业化同时推动。
...
通用、福特、菲亚特克莱斯勒、**丰田**、本田、日产、马自达、三菱、富士重工业、现代、起亚、**奥迪**、**宝马**、戴姆勒、大众、保时捷、沃尔沃、玛莎拉蒂、捷豹路虎、特斯拉

长安 智能互联 SUV CS95，上汽 智能互联 SUV RX5、智能驾驶汽车 MG iGS

#### ADAS供应商

**Bosch**、AutonomousStaff、博世、大路、德尔福、电装、Autoliy

和谐富腾、小鹏、蔚来、智车优行、乐视

#### 底层零部件供应商

激光雷达：Velodyne、IBEO（法雷奥合作）、SICK、北洋和先锋

毫米波：Delphi、大陆和Bosch

摄像头：[Mobileye](http://www.mobileye.com/zh-cn)、Omni、PointGrey、大恒和微视

机器视觉算法：中科慧眼、地平线、东软和Minieye

高精地图：HERE、TOMTOM、RoadDNA、RoadBook、百度、高德、四维图新、武汉光庭

[TI（德州仪器）](http://www.ti.com.cn/)、**[NVIDIA](http://www.nvidia.cn/object/advanced-driver-assistance-systems-cn.html)**

**Volvo**、**Comma.ai**、nuTonomy、zoox、宇通
...
预计单车保守用4个镜头（前置摄像＋两侧盲点监测＋后侧倒车影像）
