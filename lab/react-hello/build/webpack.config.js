...
alias = Object.assign(alias, pickFiles({
  id: /(components\/[^\/]+)/,
  pattern: SRC_PATH + '/components/*/index.jsx'
}));
...
alias = Object.assign(alias, pickFiles({
  id: /(actions\/[^\/]+).jsx/,
  pattern: SRC_PATH + '/jsx/actions/*'
}));

alias = Object.assign(alias, {
  'react-router': NODE_MODULES_PATH + '/react-router/lib/index.jsx',
  'react-redux': NODE_MODULES_PATH + '/react-redux/lib/index.jsx',
  'redux': NODE_MODULES_PATH + '/redux/lib/index.jsx',
  'redux-thunk': NODE_MODULES_PATH + '/redux-thunk/lib/index.jsx'
});
...
var config = {
  ...
  output: {
    ...
    filename: __DEV__ ? 'jsx/[name].jsx' : 'jsx/[name].[chunkhash].jsx',
    chunkFilename: __DEV__ ? 'jsx/[name].jsx' : 'jsx/[name].[chunkhash].jsx'
  },
  module: {},
  resolve: {
    root: SRC_PATH,
...
if (uglify) {
  config.plugins.push(
    new webpack.optimize.UglifyjsxPlugin({
      compress: {
        warnings: false
      },
      output: {
